angular.module('app.layout')
    ...
    .controller('NavCtrl', ['$scope', '$mdSidenav', '$log', 'AppLayoutService', 'CustomerService', function ($scope, $mdSidenav, $log, AppLayoutService, CustomerService) {
        ...
        CustomerService.getAllCustomers().then(function (response) {
            ...
            obj.type = "toggle";
            obj.pages = [];
            for (var k = 0, len = response.length; len > k; k++) {
                var page = {};
                page.name = response[k].name;
                page.disabled = false;
                page.type = "customer";
                page.icon = "";
                page.state = "m161.adminCustomer({customerId: '"+response[k].id+"'})";

                console.log(page.state);

                obj.pages.push(page);
            }
            $scope.menu.sections.push(obj);
        });
        /*
